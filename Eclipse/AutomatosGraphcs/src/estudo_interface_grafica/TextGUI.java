...
public class TextGUI extends JFrame {
	...
	public TextGUI() {
		...
		btnCriarAutomato.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(!validar())return;
				capturarDados();
				if(aa!=null) if(aa.isVisible()) aa.dispose();
	...
	private boolean validar() {
		if("".equals(txtNome.getText())) {
			JOptionPane.showMessageDialog(null,"Entre com o Nome do Automato:","Atenção!",JOptionPane.ERROR_MESSAGE);
			return false;
	    }
		if("".equals(txtEstados.getText())) {
			JOptionPane.showMessageDialog(null,"Entre com os Estados do Automato:","Atenção!",JOptionPane.ERROR_MESSAGE);
			return false;
	    }
		if("".equals(txtAlfabeto.getText())) {
			JOptionPane.showMessageDialog(null,"Entre com o Alfabeto do Automato:","Atenção!",JOptionPane.ERROR_MESSAGE);
			return false;
	    }
		if("".equals(txtEstadosFinais.getText())) {
			JOptionPane.showMessageDialog(null,"Entre com os Estados Finais do Automato:","Atenção!",JOptionPane.ERROR_MESSAGE);
			return false;
	    }
		if("".equals(txtEstadoInicial.getText())) {
			JOptionPane.showMessageDialog(null,"Entre com o Estado inicial do Automato:","Atenção!",JOptionPane.ERROR_MESSAGE);
			return false;
	    }
		if("".equals(txtTransicoes.getText())) {
			JOptionPane.showMessageDialog(null,"Entre com as transições do Automato:","Atenção!",JOptionPane.ERROR_MESSAGE);
			return false;
	    }
		return true;
