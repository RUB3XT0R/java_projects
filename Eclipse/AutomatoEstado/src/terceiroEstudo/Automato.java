...
public class Automato {
	...
	protected class Estado {
		boolean isFinal;
		String nome;
		boolean consideracao; //usado para os algoritmos de eliminação de estados inuteis e inacessiveis
		...
		private Automato getOuterType() {
			return Automato.this;
		}
