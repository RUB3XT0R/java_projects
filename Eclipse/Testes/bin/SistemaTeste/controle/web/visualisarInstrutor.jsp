...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="corpo" id="corpo" align="center">
            ...
            <div class="viewInst">
                    <table  bgcolor="white">
                        ...
                        <tr>
                            ...
                            <td>RG:</td>
                            <td><input type="text" name="rg" value="<%= inst.getRg()%>"  OnKeyPress="formatar(this,'##.###.###-#')"/></td>
                        </tr>
                        <tr><td>Nome:</td>
            ...
            <div class="viewInstCur">
                <table>
                    <caption>Cursos que <%= inst.getNome()%> ministra:</caption>
                    <tr>
                        <th>Nome</th>
                        <th>Unidades</th>
                        <th>Período</th>
                    </tr>
                    <% for (CursoInstrutor ci : inst.getCursosQueLeciona()) {%>
                    <tr>
                        <td><%= ci.getCurso().getNome()%></td>
                        <td><%= ci.getUnidadeABC() ? " ABC " : ""%><%= ci.getUnidadeUP() ? " UP " : ""%></td>
                        <td><%= ci.getPeriodo()%></td>
                        <td>
                            <a href="visualisarCurso.jsp?id=<%= ci.getCurso().getId() %>"><img src="img/view.png" style="height: 21px; width: 21px; " /></a>
                        </td>
                    </tr>
                    <%}%>
                    <tr>
