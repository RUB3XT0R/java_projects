<%-- 
    Document   : abapfoundationI
    Created on : 24/Out/2011, 12:20:34
    Author     : Lucas Biason
--%>
...
<div align="justify">
    <table border="0"><tr>
            ...
            <td><img src="img/carga20.png" width="162" height="162" /></td>
        </tr></table>
    ...
    <table border='0' cellpadding="3" cellspacing="2" bgcolor="#CCCCCC">
        <tr bgcolor="white"><th width="566" align="center">Introdução ao SAP </th></tr>
        <tr bgcolor="white">
    ...
    <br />
    <table border='0' cellpadding="3" cellspacing="2" bgcolor="#CCCCCC">
        <tr bgcolor="white"><th width="585" align="center">Programas ABAP </th></tr>
        <tr bgcolor="white">
    ...
    <table width="100%" height="58" border='0' cellpadding="3" cellspacing="2" bgcolor="#CCCCCC">
        <tr bgcolor="white"><th width="603" align="center">Componentes ABAP </th></tr>
        <tr bgcolor="white">
    ...
    <br />
    <table border='0' cellpadding="3" cellspacing="2" bgcolor="#CCCCCC">
        <tr bgcolor="white"><th width="599" align="center"> Criação de programas </th></tr>
        <tr bgcolor="white">
    ...
    <br />
    <table border='0' cellpadding="3" cellspacing="2" bgcolor="#CCCCCC">
        <tr bgcolor="white"><th width="594" align="center"> Desenvolvimento Principal </th></tr>
        <tr bgcolor="white">
            <td align="left" valign="top"><p>-Relatório tipo List utilizando tela de seleção. Nesse ponto são apresentados os comandos fundamentais para criação de uma tela de seleção e validações básicas;</p>
                ...
                <p>-Download de relatório em arquivo TXT na maquina local.</p></td>
        </tr>
    </table>
</div>