    ...
    <body>
        ...
        <div class="corpo" id="corpo" align="center">
            ...
            <div class="newDatasCli">
                ...
                <table  bgcolor="white">
                    <caption>Removendo Cliente</caption>
                    <tr>
                        <td colspan="4">
                    ...
                    <tr>
                        ...
                        <td>Nome:</td>
                        <td><input type="text" name="nome" value="<%= cliente.getNome()%>" readonly="readonly"/></td>
                    </tr>
                    <tr>
                        <td colspan="4">
                            <p class="formSubmit">
                                <img src="img/prev.gif" width="25px;" onclick="location.href='clientes.jsp<%=(null != filtro) ? "?nome=" + filtro : ""%>'"/>Cancelar
                                | Excluir<img src="img/next.png" width="25px;" onclick="location.href='delCliente.jsp?id=<%= cliente.getId()%>'"/>
                            </p>
                        </td>                        
                    </tr>
                </table>
