 ...
 * @author Lucas Biason
 */
public class upBebida extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Float qtde = Float.parseFloat(request.getParameter("qtde"));

            //construção do link de retorno
            String goPage = "/LanchoneteJSP/bebidas.jsp?";

            //operações
            BebidaDao dao = new BebidaDao();

            if (!dao.containBebida(id)) {
