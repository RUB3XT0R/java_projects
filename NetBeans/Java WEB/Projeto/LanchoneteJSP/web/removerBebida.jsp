...
<html>
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="newDatas">
                <form name="" action="delBebida" method="post">
                    ...
                    <fieldset width="200px">
                        <table border='0'>
                            ...
                            <tr>
                                <td>Descrição</td>
                                <td><input type="text" value="<%= bebida.getDescricao()%>" name="descricao" disabled/></td>
                            </tr>
                            <tr>
                                <td>Preço R$:</td>
                                <td><input type="text" value="<%= bebida.getPreco() %>" name="preco" disabled/></td>
                            </tr>
                            <tr>
                                <th colspan="2">
