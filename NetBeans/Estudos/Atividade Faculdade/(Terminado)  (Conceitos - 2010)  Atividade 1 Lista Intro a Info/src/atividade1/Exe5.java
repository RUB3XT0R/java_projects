...
package atividade1;
/****************************************
 * Nome: Exe5.java data:18/02/2010
 * Autor: Lucas Biason
 * Descrição: calcula a media ponderada de
 * tres notas, sendo os pesos -2,3,5.
 ****************************************/
import javax.swing.*;
import java.text.*;
public class Exe5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Exercício 05) Média Ponderada (2,3,5):");
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        try{
            ...
            jTextField4.setText(String.valueOf(df.format(media)));
