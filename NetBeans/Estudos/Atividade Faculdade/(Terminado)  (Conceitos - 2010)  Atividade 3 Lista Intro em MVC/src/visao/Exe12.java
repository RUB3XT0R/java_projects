...
public class Exe12 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("3 para outras):");
        jLabel11.setBounds(30, 30, 280, 20);
        jLayeredPane1.add(jLabel11, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jLabel9.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Exercício 12) Média(peso 4 para a maior,");
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        try{
            ...
            double m=al.calculaExe12(x,y,z);
            DecimalFormat df =new DecimalFormat("#,###.00");
            jTextField4.setText(String.valueOf(df.format(m)));
            if(m>=5) {
                JOptionPane.showMessageDialog(null,"O aluno aprovado ","Resultado",JOptionPane.INFORMATION_MESSAGE);}
            else {
                JOptionPane.showMessageDialog(null,"O aluno reprovado","Resultado",JOptionPane.INFORMATION_MESSAGE);}
