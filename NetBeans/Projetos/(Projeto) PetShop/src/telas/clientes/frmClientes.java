...
public class frmClientes extends javax.swing.JFrame {
    ...
    private void loadInitialData(){
        try {
            ...
            MyTableModel t = new MyTableModel(Cliente.class,clientes,jTable1);
            jTable1.setModel(t);
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        frmAddCliente form = new frmAddCliente(dao);
        form.setVisible(true);
    }//GEN-LAST:event_btnaddActionPerformed

    private void btndelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndelActionPerformed
        if(jTable1.getSelectedRow() ==-1){
            Ferramentas.showErro("Selecione um cliente para poder remover.","ERRO!!");
            return;
        }
        if(!Ferramentas.showPergunta("Realmente deseja remover o registro?","Atenção")) return;
        try {
            dao.removeCliente(clientes.get(jTable1.getSelectedRow()).getId());
            loadInitialData();
        } catch (SQLException ex) {
            Ferramentas.showErro("Erro ao remover cliente.","ERRO!!");
        }
    ...
    private void btnupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupActionPerformed
         if(jTable1.getSelectedRow() ==-1){
            Ferramentas.showErro("Selecione um cliente para poder alterar.","ERRO!!");
            return;
        }
        frmUpCliente form = new frmUpCliente(dao,clientes.get(jTable1.getSelectedRow()));
        form.setVisible(true);
