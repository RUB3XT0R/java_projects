...
public class frmAnimais extends javax.swing.JFrame {
    ...
    private void loadInitialData(){
        try {
            animais = dao.getAllAnimal();
            jTable1.setModel(new MyTableModel(Animal.class,animais,jTable1));
    ...
    private void initComponents() {
        ...
        btndel1.setBackground(new java.awt.Color(102, 102, 102));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnup, javax.swing.GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE)
                    .addComponent(btndel, javax.swing.GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE)
                    ...
                    .addComponent(btndel1, javax.swing.GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        setBounds((screenSize.width-552)/2, (screenSize.height-470)/2, 552, 470);
    }// </editor-fold>//GEN-END:initComponents

    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        frmAddAnimais form = new frmAddAnimais(dao);
        form.setVisible(true);
    }//GEN-LAST:event_btnaddActionPerformed

    private void btndelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndelActionPerformed
        if(jTable1.getSelectedRow() ==-1){
            Ferramentas.showErro("Selecione um animal para poder remover.","ERRO!!");
            return;
        }
        if(!Ferramentas.showPergunta("Realmente deseja remover o registro?","Atenção")) return;
        try {
            dao.removeAnimal(animais.get(jTable1.getSelectedRow()).getId());
        } catch (SQLException ex) {
    ...
    private void btnupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupActionPerformed
         if(jTable1.getSelectedRow() ==-1){
            Ferramentas.showErro("Selecione um animal para poder alterar.","ERRO!!");
            return;
        }
        frmUpAnimais form = new frmUpAnimais(dao,animais.get(jTable1.getSelectedRow()));
        form.setVisible(true);
