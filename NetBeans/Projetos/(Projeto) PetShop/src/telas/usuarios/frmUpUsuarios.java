...
public class frmUpUsuarios extends javax.swing.JFrame {

    private UsuarioDao dao = new UsuarioDao();
    private Usuario userInEdit;

    public frmUpUsuarios() {
        initComponents();
        this.setLocationRelativeTo(null);
    }
    public frmUpUsuarios(UsuarioDao dao, Usuario userInEdit){
        this();
        this.dao = dao;
    ...
    private void initMyComponents(){
        txtnome.setText(userInEdit.getNome());
        txtlogin.setText(userInEdit.getLogin());
        txtsenha.setText(userInEdit.getPassword());
        txtconfirme.setText(userInEdit.getPassword());
    ...
    private void btnokActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnokActionPerformed
        ...
        userInEdit.setNome(txtnome.getText());
        userInEdit.setPassword(txtsenha.getText());

        if(! Ferramentas.showPergunta("Realmente deseja alterar o registro?","Atenção")) return;
        try {
            dao.updateUsuario(userInEdit);
