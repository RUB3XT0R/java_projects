...
public class LoginDao extends Dao{
    ...
    public void removeLogin(int idUsuario) throws SQLException{
        executeCommand("delete from login where id_funcionario=?",idUsuario);
    }
    public void removeLoginById(int id) throws SQLException{
        executeCommand("delete from login where id=?",id);
    }
